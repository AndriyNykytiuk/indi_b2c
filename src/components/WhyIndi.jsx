...
function WhyIndi() {
  return (
    <section className='why-indi'>
        <div className='why-indi-container mx-auto max-w-[1280px] flex flex-col items-center justify-center p-20 bg-[#F9FAFB] rounded-[64px]'>
            <div className='why-indi__title-top flex flex-col gap-5 items-start justify-center md:flex-row gap-5 items-start justify-center mb-[40px]'>
                <div className='why-indi__title font-bold text-[48px] max-w-[526px]'>
            ...
            <div className=' why-indi__items max-w-[1055px] grid grid-cols-1 place-items-center justify-center md:grid-cols-3 gap-[20px] m-10'>
                <div className='why-indi__item item p-[60px] max-w-[370px] max-h-[390px] bg-[#FFFFFF] p-5 rounded-[64px] shadow-md flex flex-col items-start justify-start gap-[15px]'>
